	            ...
	            if(current instanceof Window){
	                switch (((Window) current).getWindowType()){
	                    ...
	                    case NEWACCOUNT:
                            ...
                            {
                                lblUsernameNotAvaiable.setVisible(true);
                                lblEmailDoesnExists.setVisible(true);
                            ...
                            {
                                lblUsernameNotAvaiable.setVisible(false);
                                lblEmailDoesnExists.setVisible(false);
	                    ...
	                    case ANONYMOUSLOGIN:
	                        ...
	                        {
                                lblServerIpAddress_2.setVisible(true);
                            }
                            else {
