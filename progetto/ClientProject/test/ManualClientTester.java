        ...
        while (true) {
            ...
            switch (scelta) {
                ...
                case 2:
                    System.out.println("Inserisci username");
                    username=bufferRead.readLine();
                    clients.add(currentClient=new AnonymousClient(pubKey,privKey));
                    break;
                case 3:
                    for(int i=0;i<clients.size();i++){
                        ...
                        if(it instanceof Client) {
                            ...
                            System.out.println("i:"+i+"  username:anonymous cookie:"+it.getCookie());
                        }
                    }
                ...
                case 5:
                    ...
                    if(it instanceof Client)  {
                        ...
                        System.out.println("username:anonymous cookie:"+it.getCookie());
                    }
                    break;
                case 6:
