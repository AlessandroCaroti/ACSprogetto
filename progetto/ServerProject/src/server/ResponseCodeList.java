...
class ResponseCodeList {
    ...
    final static   ResponseCode InvalidUsernameOrEmail=new ResponseCode(ResponseCode.Codici.R660,ResponseCode.TipoClasse.SERVER,"Username or email already in use! Repeat the procedure.");
